<div align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/3514/3514491.png" alt="Shopvilla Logo" width="80" />
  <h1>Shopvilla - Full-Stack MERN E-Commerce App</h1>
...
From the **root folder** `shopvilla/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@shopvilla.com` | Password: `password123`
...
This repository includes a fully-scaffolded API testing toolkit: **`Shopvilla_Postman_Collection.json`**. 
