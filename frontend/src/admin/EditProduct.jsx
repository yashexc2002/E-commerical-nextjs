...
const EditProduct = () => {
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '40px auto', background: '#0f2341', padding: '40px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
      <h2 style={{ color: '#38bdf8', marginBottom: '20px' }}>Edit Product</h2>
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <div style={{ padding: '15px', border: '1px dashed #38bdf8', borderRadius: '8px' }}>
...
const inputStyle = { padding: '12px', background: '#071426', border: '1px solid #102a4c', borderRadius: '6px', color: '#fff', fontSize: '15px', outline: 'none' };
