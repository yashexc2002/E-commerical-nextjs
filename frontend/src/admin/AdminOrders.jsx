...
const AdminOrders = () => {
  ...
  return (
    <div style={containerStyle}>
      <h2 style={{ color: '#38bdf8', marginBottom: '20px' }}>Manage Orders</h2>
              ...
              <tr key={order._id} style={rowStyle}>
                ...
                <td style={tdStyle}>
                  <select 
                    ...
                    style={{ background: '#071426', color: '#fff', padding: '6px', border: '1px solid #102a4c', borderRadius: '4px', outline: 'none' }}
                  >
